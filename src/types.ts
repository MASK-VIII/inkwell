...
export type Manuscript = {
  ...
  /** Writer-facing master page type (Contents, Title, Copyright, …). */
  masterKind?: MasterPageKind
  /** Built-in Contents body is regenerated by the app. */
