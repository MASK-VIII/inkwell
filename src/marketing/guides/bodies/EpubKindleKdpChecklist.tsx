export default function EpubKindleKdpChecklistBody() {
  return (
    <>
      ...
      <p>
        Inkwell is built around this digital path: draft chapter-first, preview the ebook layout while
        you write, then export EPUB when you are ready to publish. It is free, local-first, and every
        export format is included.
      </p>

      <h2>Related guides</h2>
      <p>
        <a href="/guides/export-anxiety">When exports feel scary</a> and{' '}
        <a href="/guides/chapter-first-outlining">chapter-first structure</a> pair well with this checklist.
      </p>

      <p>
        Ready to try the workflow? <a href="/app#bookshelf">Open Inkwell free</a>—no signup, EPUB export included.
      </p>
    </>
  )
}
