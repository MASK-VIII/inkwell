      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-16 sm:gap-14 sm:px-8 sm:py-28 lg:grid-cols-[1.05fr_1fr] lg:gap-16">
        <div className="flex flex-col gap-7">
          ...
          <p className="max-w-xl text-lg leading-relaxed text-walnut/90 dark:text-ink-dark/82">
            A local-first workspace for long-form fiction: stay in the draft, preview print and ebook layouts, then export—free, on your device, no account required.
          </p>
          <ul className="max-w-xl space-y-2 text-base leading-relaxed text-walnut/90 dark:text-ink-dark/82">
            <li className="flex gap-2.5">
              ...
              <span>
                <span className="font-medium text-ink dark:text-ink-dark">Free, no signup</span>
                —the full chapter-first writing workspace, on your device.
              </span>
            </li>
            <li className="flex gap-2.5">
              <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-walnut/50 dark:bg-accent-warm/70" aria-hidden />
              <span>
                <span className="font-medium text-ink dark:text-ink-dark">Every export included</span>
                —EPUB, print-ready PDF, DOCX, Markdown, and plain text.
              </span>
            </li>
            <li className="flex gap-2.5">
              <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-walnut/50 dark:bg-accent-warm/70" aria-hidden />
              <span>
                <span className="font-medium text-ink dark:text-ink-dark">Yours, offline</span>
                —your manuscripts live on your device, in the browser or the desktop app.
              </span>
            </li>
          </ul>
          <p className="max-w-xl text-sm leading-relaxed text-walnut/78 dark:text-ink-dark/70">
            Inkwell 1.0 is built and supported by one person—human support and fast fixes when edge cases show up.
          </p>
          ...
          <p className="text-xs text-walnut/65 dark:text-ink-dark/68">
            Free and local-only. No account, no subscription, no upsell—every writing and export feature is included.
          </p>
        </div>
